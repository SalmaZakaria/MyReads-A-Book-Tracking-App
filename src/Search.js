        ...
        return ( 
            ...
            <div className="search-books-bar">       
              <div className="search-books-input-wrapper">
                ...
                value={Query}
                onChange={(event) => this.DispalyBooks(event.target.value)}/>
              </div>
            </div>
            <Link
            to='/'
            ...
            <div className="search-books-results">
                      ...
                      Queries.map(book => (
                        ...
                        <div className="book">
                            <div className="book-top">
                                {
                                    this.ImageFound(book) === true ? <div className="book-cover" style={{ width: 120, height: 180, backgroundImage: `url(${book.imageLinks.thumbnail})`}}></div> : 
                                    <div className="book-cover" style={{ width: 120, height: 180, backgroundColor: 'grey'}}></div>
              ...
              {
                  <h2 style={{textAlign: 'center'}}>No Books have been Found</h2>
               }
            </div>
          </div>
         );
